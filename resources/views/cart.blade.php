                                        ...
                                        <tr class="cart_item">
                                            ...
                                            <td class="product-thumbnail">
                                                ...
                                                <div class="cart-product__item">
                                                    <a href="#">
                                                        <img src="{{asset('images/'.$pdt->model->photo)}}" alt="product" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image">
                                                    </a>
                                            ...
                                            <td class="product-quantity">
                                                ...
                                                <div class="quantity">
                                                    <a href="{{route('product.decr', ['rowId'=>$pdt->rowId, 'qty'=>$pdt->qty])}}" class="quantity-minus">-</a>
                                                    <input title="Qty" name="qty" class="email input-text qty text" type="text" value="{{$pdt->qty}}" placeholder="" readonly>
